...
public class Demo {
	...
	public static void main(String[] args) {
		//Representation of finding the path with the smallest distance from S -> G
		//With different algorithm scenarios
		...
		env.addAgent(agent, agentLoc);
		env.stepUntilDone();
		envView.notify(DepthFirstSearch.getMetrics().toString());
		...
		env.addAgent(agent, agentLoc);
		env.stepUntilDone();
		envView.notify(BreadthFirstSearch.getMetrics().toString());
